    ...
    <div>
      <Form {...form}>
        ...
        >
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Textarea rows={6} placeholder='Descripción del producto' {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <button className='group relative inline-flex h-12 w-full items-center justify-center overflow-hidden rounded-md bg-neutral-950 px-6 font-medium text-neutral-100 dark:bg-white dark:text-neutral-800'>
