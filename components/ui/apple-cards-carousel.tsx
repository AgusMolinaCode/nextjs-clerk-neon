...
import { LucideArrowBigRight, LucideArrowBigLeft, LucideX } from 'lucide-react'
    ...
    >
      <div className='relative w-full'>
          ...
          >
            {items.map((item, index) => (
              <motion.div
                ...
                key={'card' + index}
                className='rounded-3xl last:pr-[1%] dark:border dark:border-gray-600'
              >
                {item}
              </motion.div>
            ))}
        ...
        <div className='mr-10 flex justify-end gap-2'>
          <button
            className='relative z-40 flex h-10 w-10 items-center justify-center rounded-full bg-gray-800 disabled:opacity-50 dark:bg-gray-100'
            onClick={scrollLeft}
            disabled={!canScrollLeft}
          >
            <LucideArrowBigLeft className='h-6 w-6 text-gray-100 dark:text-gray-800' />
          </button>
          <button
            className='relative z-40 flex h-10 w-10 items-center justify-center rounded-full bg-gray-800 disabled:opacity-50 dark:bg-gray-100'
            onClick={scrollRight}
          ...
          >
            <LucideArrowBigRight className='h-6 w-6 text-gray-100 dark:text-gray-800' />
          </button>
        </div>
      </div>
    </CarouselContext.Provider>
          ...
          <div className='fixed inset-0 z-50 h-screen overflow-auto'>
            ...
            >
              <button
                ...
                onClick={handleClose}
              >
                <LucideX className='h-6 w-6 text-neutral-100 dark:text-neutral-900' />
              </button>
              <motion.p
